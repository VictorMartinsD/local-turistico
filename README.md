...
<p align="center">
  <img src="https://github.com/user-attachments/assets/5c1b0d7d-685c-4031-962a-649bbbec652c" alt="Screenshot do topo da Landing Page de Busan" width="700">
  <br>
  <img src="https://github.com/user-attachments/assets/27cc5b49-d683-452e-b27c-3b6a44f787b5" alt="Screenshot da seção de destaques de Busan" width="700">
  <br>
...
O projeto foi desenvolvido utilizando as tecnologias base da web:

* **HTML5:** Estrutura e semântica do conteúdo.
* **CSS3:** Estilização, layout e aparência.
* **Google Fonts:** Utilização das fontes 'Alice' e 'Open Sans'.

## 🎨 Design System e Tipografia

O projeto segue um sistema de design específico para garantir a consistência visual:
...
The project follows a specific design system to ensure visual consistency:
